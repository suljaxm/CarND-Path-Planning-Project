...
//start: 784.6001 1135.571 0                -0.02359831 -0.9997216  
//end  : 753.2067 1136.417 6914.14925765991 -0.107399   -0.9942161    
//    x        y         s               dx         dy
        ...
        if (event == "telemetry") {
          ...
          */
          ...
          // use the previous path's end point as starting reference
              ...
              //reference state as previous path end point
          ...
          //calculate how to break up spline points so that we traval at out desired reference velocity
          ...
          //fill up the reset of our path planner after filling it with previous points, here we will always output 50 points.
          for (int i = 0; i < 50 - previous_path_x.size(); i++){
              ...
              // rotate bock to normal after rotating it eariler
